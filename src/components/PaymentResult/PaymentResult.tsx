...
const PaymentResult = () => {
  ...
  return (
    <div className={styles.overlay} onClick={() => setVisible(false)}>
      <div className={`${styles.card} ${content.className}`} onClick={(e) => e.stopPropagation()}>
        ...
        <a href={content.ctaUrl} target="_blank" rel="noopener noreferrer" className={styles.cta}>
          {content.cta}
        </a>
